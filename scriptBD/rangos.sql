...
CREATE TABLE `rangos` (
  ...
  `act_directos` varchar(250) DEFAULT NULL,
  `directores_diamante` varchar(250) DEFAULT NULL,
  `nivel` varchar(250) DEFAULT NULL,
  `vol_grupal` varchar(250) DEFAULT NULL,
...
INSERT INTO `rangos` (`id`, `nombre`, `act_directos`, `directores_diamante`, `nivel`, `vol_grupal`, `estado`, `photoDB`, `created_at`, `updated_at`) VALUES
